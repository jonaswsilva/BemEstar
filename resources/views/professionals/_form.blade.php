<h3 class="header smaller lighter purple">Dados Pessoais</h3>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					{!! Form::password('password', '', ['class' => 'col-xs-10 col-sm-5', 'placeholder' => 'Senha...']) !!}
					@if($errors->any())
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					{!! Form::password('password_confirmation', '', ['class' => 'col-xs-10 col-sm-5', 'placeholder' => 'Confirmar senha...']) !!}
					@if($errors->any())
					<div class="red darken-4">&nbsp &nbsp{!! $errors->first('password_confirmation') !!}</div>
					@endif
				</div>
			</div>
