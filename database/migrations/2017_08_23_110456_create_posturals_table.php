  ...
  */
  public function up()
  {
    Schema::create('posturals', function (Blueprint $table) {
      $table->increments('id');
      $table->integer('medicalappointment_id')->unsigned();
      $table->foreign('medicalappointment_id')->references('id')->on('medical_appointments')->onUpdate('cascade')->onDelete('cascade');
